    ...
    <div className={`flex flex-col gap-2 ${isFullscreen ? 'p-4' : 'p-0'}`}>
      {items.map((item, index) => (
        <div
          ...
          } p-4 relative rounded-lg border border-border dark:border-border-dark overflow-hidden cursor-pointer`}
        >
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0">
              ...
              />
              <h3
                className={`text-[18px] font-medium text-primary-text dark:text-primary-text-dark truncate flex-1 ${
          ...
          <div className="flex justify-between mt-3">
            <div
              ...
              } text-sm text-primary-text/70 dark:text-primary-text-dark/70`}
            >
            ...
            {item.active && (
              <div className="flex items-center gap-4 text-[14.5px] text-primary-text/70 dark:text-primary-text-dark/70">
