      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl mb-12 text-gray-300 font-light">
            The power user's alternative to TorBox UI. Built for speed and efficiency.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="p-8 bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-3 text-blue-400">Batch Upload</h3>
              <p className="text-gray-300">Upload multiple torrents with a single click</p>
            </div>
            <div className="p-8 bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-3 text-violet-400">Smart Downloads</h3>
              <p className="text-gray-300">Cherry-pick specific files across multiple torrents</p>
            </div>
            <div className="p-8 bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-3 text-indigo-400">Your Workflow</h3>
              <p className="text-gray-300">Customize the interface to match your needs</p>
            </div>
          </div>
